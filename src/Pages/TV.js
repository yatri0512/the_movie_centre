...
const TV = () => {
  ...
  const fetchTrendingTV = async () => {
    const data = await 
    fetch(`https://api.themoviedb.org/3/discover/tv?api_key=f982499e3a554ab1e87427f63fb08db6&language=en-US&sort_by=popularity.desc&include_adult=false&include_video=false&page=${page}&with_genres=${genreURL}`);
